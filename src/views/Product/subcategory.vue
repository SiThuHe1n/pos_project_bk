...
export default {
    ...
    methods: {
     ...
     axios.get(localStorage.getItem("link")+"/api/subcategory")
    ...
    //                 
             ...
             {
                axios.post(localStorage.getItem("link")+"/api/subcategory", this.$refs.form)
       .then(response =>{console.log(response)
        this.doshow();
       ...
       .catch(error => {
         ...
         console.error("There was an error!", error);
                ...
                axios.patch(localStorage.getItem("link")+"/api/subcategory/"+this.id, article)
       .then(response =>{console.log(response)
        this.doshow();
       ...
       .catch(error => {
        ...
        {
            axios.delete(localStorage.getItem("link")+"/api/subcategory/"+id)
       .then(response =>{console.log(response)
        this.doshow();
